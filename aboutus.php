        ...
        <div style="position:relative;">
            ...
            <div id="sidr-right">
                <ul>
                    ...
                    <li>
                        <a href="aboutus.php?lang=th" style="font-size:22pt;">
                            <img src="images/ico_language_th.png" /> <?php echo $wording[$_SESSION['lang']]['menu_lang_th']; ?>
                        </a>
                    </li>
                    <li>
                        <a href="aboutus.php?lang=en" style="font-size:22pt;">
            ...
            <div style="background-color: #1f1f1f;padding-bottom:100px;">
                <div style="width:100%;background-color:black;text-align: center;">
                    <img src="images/logo_about_us_white_night_soft.png" class="img-responsive" />
                </div>

                <div style="max-width:1000px;margin:0px auto;padding:10px 0px;">
                    <div style="text-align: center;font-size:60pt;color:#ffa500;font-family: pgvim;"><?php echo $wording[$_SESSION['lang']]['aboutus_header']; ?></div>
                    <div style='text-align:center;color:#d9d9d9;font-size:12pt;margin-bottom:20px;'>
                        <?php echo $wording[$_SESSION['lang']]['aboutus_detail1']; ?> <br />
                        <?php echo $wording[$_SESSION['lang']]['aboutus_detail2']; ?> <br />
                        <?php echo $wording[$_SESSION['lang']]['aboutus_detail3']; ?>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6" style='margin-bottom:10px;text-align: center;'>
                        <a href="makruk.php">
                            <img src="images/img_staff_CEO.png" style="margin-bottom: 5px;"/>
                            <br />
                            <span style="color:#d9d9d9;font-size:12pt;">S. Pawanwit <br />CEO / Developer</span>
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6" style='margin-bottom:10px;text-align: center;'>
                        <a href="#">
                            <img src="images/img_staff_UI_&_UX_Specialist.png" style="margin-bottom: 5px;"/>
                            <br />
                            <span style="color:#d9d9d9;font-size:12pt;">B. Monsit <br />UI / UX Specialist</span>
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6" style='margin-bottom:10px;text-align: center;'></div>
                    <div style="clear:both;margin-bottom:0px;"></div>
                    <div style='text-align:center;color:#d9d9d9;font-size:12pt;margin-top:20px;'>
                        Email : contact@whitenightsoft.com
                    </div>
                </div>
            </div>
